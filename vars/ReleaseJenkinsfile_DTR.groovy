    ...
    node ('INBLRCYBDTRCHP90') {
        try {	
            ...
            stage ('Twistcli Scan') {
                ...
                ///sh 'sudo bash /root/Hardening-Team-Development/Release-SingleImage/TwistcliScan_Release.sh $HardenImage $twistlock_user $twistlock_pass'  
                sh 'sudo bash ./resources/TwistcliScan_Release.sh $HardenImage $twistlock_user $twistlock_pass'
                }
                script {
